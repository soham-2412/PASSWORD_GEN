...
root.title("Soham Password generator ")
...
Title = Label(root, text="Soham Password generator", bg="beige", fg="black", font=("futura", 15, "bold"))
...
generate_btn = Button(root, text="Generate Password", bg="yellow", fg="black", font=("ubuntu", 15), cursor="hand2", command=password_generate)
...
result_lable = Label(root, text="Generated Password Here :- ", bg="pink", fg="darkgreen", font=("ubuntu", 12))
